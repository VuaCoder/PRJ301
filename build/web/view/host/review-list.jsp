                ...
                <div class="review-item">
                    <div class="review-header">
                        <div class="reviewer-info">
                            <div class="reviewer-avatar">
                                <c:choose>
                                    <c:when test="${not empty review.bookingId.customerId.userId.fullName}">
                                        ${fn:substring(review.bookingId.customerId.userId.fullName, 0, 1)}
                                    </c:when>
                    ...
                    <div class="room-info">
                        ...
                        <div class="room-location">
                            ...
                            <c:choose>
                                <c:when test="${not empty review.bookingId.roomId.propertyId.city}">
                                    ${review.bookingId.roomId.propertyId.city}
                                </c:when>
